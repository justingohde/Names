...
const dest = '../../../data/clean/density/states';
...
files.forEach(function(file) {
  ...
  if (file != ".DS_Store") {
    ...
    for (year in densityInfo) {
      densityInfo[year]["fDensity"] = parseFloat((densityInfo[year]["F"].length / densityInfo[year]["fCount"]).toFixed(5));
      densityInfo[year]["mDensity"] = parseFloat((densityInfo[year]["M"].length / densityInfo[year]["mCount"]).toFixed(5));
    }
